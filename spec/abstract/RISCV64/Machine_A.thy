...
text {*
  ...
  types for the RISCV64 architecture. Other architectures may have slightly
...
text {* The lowest virtual address in the kernel window. The kernel reserves the virtual addresses
