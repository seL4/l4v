...
\<close>
definition arch_mask_interrupts :: "bool \<Rightarrow> irq list \<Rightarrow> (unit,'z::state_ext) s_monad"
where
...
definition arch_domainswitch_flush :: "(unit,'z::state_ext) s_monad"
where
  "arch_domainswitch_flush \<equiv> do
    ...
    \<comment>\<open> $do_machine_op$ clearTouchedAddresses\<close>
   od"
