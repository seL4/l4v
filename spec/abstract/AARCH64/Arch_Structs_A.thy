...
definition table_size :: nat
  where
  "table_size = ptTranslationBits False + pte_bits"
...
(* FIMXE AARCH64: needs to be defined in design/AARCH64/Arch_Structs_B.thy  *)
(*
...
(* FIXME AARCH64: add when type def above works
