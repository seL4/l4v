...
datatype kernel_state =
    X64KernelState "asid \<Rightarrow> ((machine_word) option)" "asid \<Rightarrow> ((machine_word) option)" machine_word "machine_word list" "machine_word list" "machine_word list" cr3

primrec
  x64KSCurrentCR3 :: "kernel_state \<Rightarrow> cr3"
where
  "x64KSCurrentCR3 (X64KernelState v0 v1 v2 v3 v4 v5 v6) = v6"

primrec
  x64KSGlobalPDs :: "kernel_state \<Rightarrow> machine_word list"
where
  "x64KSGlobalPDs (X64KernelState v0 v1 v2 v3 v4 v5 v6) = v4"

primrec
  x64KSASIDMap :: "kernel_state \<Rightarrow> asid \<Rightarrow> ((machine_word) option)"
where
  "x64KSASIDMap (X64KernelState v0 v1 v2 v3 v4 v5 v6) = v1"

primrec
  x64KSASIDTable :: "kernel_state \<Rightarrow> asid \<Rightarrow> ((machine_word) option)"
where
  "x64KSASIDTable (X64KernelState v0 v1 v2 v3 v4 v5 v6) = v0"

primrec
  x64KSGlobalPDPTs :: "kernel_state \<Rightarrow> machine_word list"
where
  "x64KSGlobalPDPTs (X64KernelState v0 v1 v2 v3 v4 v5 v6) = v3"

primrec
  x64KSGlobalPML4 :: "kernel_state \<Rightarrow> machine_word"
where
  "x64KSGlobalPML4 (X64KernelState v0 v1 v2 v3 v4 v5 v6) = v2"

primrec
  x64KSGlobalPTs :: "kernel_state \<Rightarrow> machine_word list"
where
  "x64KSGlobalPTs (X64KernelState v0 v1 v2 v3 v4 v5 v6) = v5"

primrec
  x64KSCurrentCR3_update :: "(cr3 \<Rightarrow> cr3) \<Rightarrow> kernel_state \<Rightarrow> kernel_state"
where
  "x64KSCurrentCR3_update f (X64KernelState v0 v1 v2 v3 v4 v5 v6) = X64KernelState v0 v1 v2 v3 v4 v5 (f v6)"

primrec
  x64KSGlobalPDs_update :: "((machine_word list) \<Rightarrow> (machine_word list)) \<Rightarrow> kernel_state \<Rightarrow> kernel_state"
where
  "x64KSGlobalPDs_update f (X64KernelState v0 v1 v2 v3 v4 v5 v6) = X64KernelState v0 v1 v2 v3 (f v4) v5 v6"
...
where
  "x64KSASIDMap_update f (X64KernelState v0 v1 v2 v3 v4 v5 v6) = X64KernelState v0 (f v1) v2 v3 v4 v5 v6"
...
where
  "x64KSASIDTable_update f (X64KernelState v0 v1 v2 v3 v4 v5 v6) = X64KernelState (f v0) v1 v2 v3 v4 v5 v6"

primrec
  x64KSGlobalPDPTs_update :: "((machine_word list) \<Rightarrow> (machine_word list)) \<Rightarrow> kernel_state \<Rightarrow> kernel_state"
where
  "x64KSGlobalPDPTs_update f (X64KernelState v0 v1 v2 v3 v4 v5 v6) = X64KernelState v0 v1 v2 (f v3) v4 v5 v6"

primrec
  x64KSGlobalPML4_update :: "(machine_word \<Rightarrow> machine_word) \<Rightarrow> kernel_state \<Rightarrow> kernel_state"
where
  "x64KSGlobalPML4_update f (X64KernelState v0 v1 v2 v3 v4 v5 v6) = X64KernelState v0 v1 (f v2) v3 v4 v5 v6"

primrec
  x64KSGlobalPTs_update :: "((machine_word list) \<Rightarrow> (machine_word list)) \<Rightarrow> kernel_state \<Rightarrow> kernel_state"
where
  "x64KSGlobalPTs_update f (X64KernelState v0 v1 v2 v3 v4 v5 v6) = X64KernelState v0 v1 v2 v3 v4 (f v5) v6"

abbreviation (input)
  X64KernelState_trans :: "(asid \<Rightarrow> ((machine_word) option)) \<Rightarrow> (asid \<Rightarrow> ((machine_word) option)) \<Rightarrow> (machine_word) \<Rightarrow> (machine_word list) \<Rightarrow> (machine_word list) \<Rightarrow> (machine_word list) \<Rightarrow> (cr3) \<Rightarrow> kernel_state" ("X64KernelState'_ \<lparr> x64KSASIDTable= _, x64KSASIDMap= _, x64KSGlobalPML4= _, x64KSGlobalPDPTs= _, x64KSGlobalPDs= _, x64KSGlobalPTs= _, x64KSCurrentCR3= _ \<rparr>")
where
  "X64KernelState_ \<lparr> x64KSASIDTable= v0, x64KSASIDMap= v1, x64KSGlobalPML4= v2, x64KSGlobalPDPTs= v3, x64KSGlobalPDs= v4, x64KSGlobalPTs= v5, x64KSCurrentCR3= v6 \<rparr> == X64KernelState v0 v1 v2 v3 v4 v5 v6"
