...
type_synonym register = "ARMMachineTypes.register"
...
where
"msgInfoRegister \<equiv> Register ARMMachineTypes.msgInfoRegister"

definition
msgRegisters :: "register list"
where
"msgRegisters \<equiv> map Register ARMMachineTypes.msgRegisters"

definition
capRegister :: "register"
where
"capRegister \<equiv> Register ARMMachineTypes.capRegister"

definition
badgeRegister :: "register"
where
"badgeRegister \<equiv> Register ARMMachineTypes.badgeRegister"

definition
frameRegisters :: "register list"
where
"frameRegisters \<equiv> map Register ARMMachineTypes.frameRegisters"

definition
gpRegisters :: "register list"
where
"gpRegisters \<equiv> map Register ARMMachineTypes.gpRegisters"

definition
exceptionMessage :: "register list"
where
"exceptionMessage \<equiv> map Register ARMMachineTypes.exceptionMessage"

definition
syscallMessage :: "register list"
where
"syscallMessage \<equiv> map Register ARMMachineTypes.syscallMessage"

definition
sanitiseRegister :: "register \<Rightarrow> machine_word \<Rightarrow> machine_word"
where
"sanitiseRegister x0 x1\<equiv> (case (x0, x1) of
    (((* Register *) r), ((* Word *) w)) \<Rightarrow>    Word $ ARMMachineTypes.sanitiseRegister r w
  )"
