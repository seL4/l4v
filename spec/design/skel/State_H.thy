...
#INCLUDE_HASKELL SEL4/Machine/RegisterSet.lhs Arch=ARMMachineTypes all_bits NOT UserContext UserMonad getRegister setRegister newContext mask Word PPtr
