...
> module SEL4.Object.VCPU.ARM(vcpuBits, decodeARMVCPUInvocation, performARMVCPUInvocation, vcpuFinalise, vcpuSwitch, vcpuFlush, vcpuFlushIfCur, dissociateVCPUTCB, vgicMaintenance, vppiEvent, irqVPPIEventIndex) where
...
> vcpuFlushIfCur :: PPtr TCB -> Kernel ()
> vcpuFlushIfCur t = do
>     curVCPU <- gets (armHSCurVCPU . ksArchState)
