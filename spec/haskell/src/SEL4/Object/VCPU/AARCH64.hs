...
module SEL4.Object.VCPU.AARCH64(curVCPUActive, vcpuBits, decodeARMVCPUInvocation, performARMVCPUInvocation, vcpuFinalise, vcpuSwitch, vcpuFlush, vcpuFlushIfCur, dissociateVCPUTCB, vgicMaintenance, vppiEvent, irqVPPIEventIndex) where
