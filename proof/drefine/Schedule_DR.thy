  ...
  apply (rule stronger_corres_guard_imp)
   ...
   apply (case_tac "cur \<noteq> idle_thread s'")
    ...
    apply (auto simp: transform_def transform_current_thread_def all_active_tcbs_def transform_objects_def active_tcbs_in_domain_def etcb_at_def
                      tcb_boundntfn_slot_def tcb_boundvcpu_slot_def tcb_pending_op_slot_def
...
lemma schedule_switch_thread_helper:
  ...
  apply (auto simp: transform_def transform_current_thread_def all_active_tcbs_def
                    transform_objects_def active_tcbs_in_domain_def etcb_at_def
                    tcb_boundvcpu_slot_def map_add_def restrict_map_def option_map_def
                    transform_object_def transform_tcb_def valid_idle_def pred_tcb_at_def
                    get_tcb_def tcb_pending_op_slot_def tcb_boundntfn_slot_def
                    transform_cnode_contents_def infer_tcb_pending_op_def transform_cap_def
                    domIff st_tcb_at_kh_def obj_at_def only_idle_def etcbs_of'_def
              split: option.splits if_split Structures_A.kernel_object.splits
...
lemma schedule_choose_new_thread_helper:
  ...
  apply (drule_tac s="idle_thread s" in sym)
  apply (auto simp: transform_def transform_current_thread_def all_active_tcbs_def transform_objects_def active_tcbs_in_domain_def etcb_at_def
                    etcbs_of'_def tcb_boundvcpu_slot_def
                    map_add_def restrict_map_def option_map_def transform_object_def transform_tcb_def valid_idle_def st_tcb_def2 get_tcb_def
...
lemma activate_thread_corres:
  ...
  apply (case_tac  "tcb_state obj'")
         apply (clarsimp simp: infer_tcb_pending_op_def tcb_pending_op_slot_def
                               tcb_boundntfn_slot_def tcb_boundvcpu_slot_def
