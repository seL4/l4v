...
apply (simp add:checkValidIPCBuffer_def ArchVSpace_H.checkValidIPCBuffer_def)
  apply (cases "isArchPageCap cp \<and> \<not> isDeviceCap cp")
   ...
   apply (cinit lift: vptr_' cap_')
    apply (simp add: ArchVSpace_H.checkValidIPCBuffer_def  if_1_0_0 del: Collect_const)
    apply csymbr
    apply csymbr
