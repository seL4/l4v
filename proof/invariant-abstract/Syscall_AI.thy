...
lemma awaken_ct_in_state[wp]:
  "awaken \<lbrace>ct_in_state P\<rbrace>"
  apply (clarsimp simp: awaken_def awaken_body_def tcb_release_dequeue_def possible_switch_to_def)
  apply (rule whileLoop_wp)
