...
declare arch_get_sanitise_register_info_inv[Arch_assms]

crunch handle_arch_fault_reply, arch_get_sanitise_register_info
  for pred_tcb_at[wp,Arch_assms]: "\<lambda>s. N (pred_tcb_at proj P t s)"
...
crunch handle_arch_fault_reply, arch_get_sanitise_register_info
  for valid_mdb[wp,Arch_assms]: valid_mdb
crunch handle_arch_fault_reply, arch_get_sanitise_register_info
