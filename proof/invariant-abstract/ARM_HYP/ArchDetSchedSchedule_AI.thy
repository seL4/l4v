...
crunch valid_etcbs [wp, DetSchedSchedule_AI_assms]:
  arch_switch_to_idle_thread, arch_switch_to_thread, vcpu_disable, vcpu_restore, vcpu_save, set_vm_root, arch_tcb_sanitise_condition
  valid_etcbs
...
crunch ct_not_in_q[wp, DetSchedSchedule_AI_assms]: arch_switch_to_thread, arch_tcb_sanitise_condition ct_not_in_q
  (simp: whenE_def ignore: clearExMonitor)

crunch is_activatable[wp, DetSchedSchedule_AI_assms]: arch_switch_to_thread, arch_tcb_sanitise_condition "is_activatable t"
  (simp: whenE_def ignore: clearExMonitor)

crunch valid_sched_action[wp, DetSchedSchedule_AI_assms]: arch_switch_to_thread, arch_tcb_sanitise_condition valid_sched_action
  (simp: whenE_def ignore: clearExMonitor)
...
crunch valid_sched[wp, DetSchedSchedule_AI_assms]: arch_switch_to_thread, arch_tcb_sanitise_condition valid_sched
  (simp: whenE_def ignore: clearExMonitor)
...
crunch cur_tcb [wp, DetSchedSchedule_AI_assms]: handle_arch_fault_reply, handle_vm_fault, arch_tcb_sanitise_condition cur_tcb

crunch not_cur_thread [wp, DetSchedSchedule_AI_assms]: make_arch_fault_msg, arch_tcb_sanitise_condition "not_cur_thread t'"
crunch valid_sched    [wp, DetSchedSchedule_AI_assms]: make_arch_fault_msg valid_sched
crunch ready_queues   [wp, DetSchedSchedule_AI_assms]: make_arch_fault_msg, arch_tcb_sanitise_condition "\<lambda>s. P (ready_queues s)"
crunch valid_etcbs    [wp, DetSchedSchedule_AI_assms]: make_arch_fault_msg valid_etcbs

crunch scheduler_action [wp, DetSchedSchedule_AI_assms]: make_arch_fault_msg, arch_tcb_sanitise_condition "\<lambda>s. P (scheduler_action s)"
