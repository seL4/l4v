...
\<comment> \<open>FIXME: if tcb_at and related terms were moved to InvariantsPre_AI then this lemma could go in
     ArchInvariants_AI.\<close>
...
\<comment> \<open>FIXME: is_tcb_cur_fpu can't be defined like this because arch_tcb_at isn't defined until
     Invariants_AI.\<close>
