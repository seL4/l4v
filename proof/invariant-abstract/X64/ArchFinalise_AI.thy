...
crunch empty[wp]: flush_all, invalidateLocalPageStructureCacheASID, lookup_pt_slot, set_vm_root,
...
crunch valid_cap: invalidateLocalPageStructureCacheASID, invalidate_asid_entry "valid_cap cap"
crunch valid_objs[wp]: invalidateLocalPageStructureCacheASID, invalidate_asid_entry "valid_objs"
...
crunch x64_global_pml4[wp]: invalidate_asid_entry, invalidateLocalPageStructureCacheASID
           "\<lambda>s. P (x64_global_pml4(arch_state s))"

crunch global_refs_invs[wp]: invalidateLocalPageStructureCacheASID
