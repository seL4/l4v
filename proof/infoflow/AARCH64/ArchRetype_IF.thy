...
lemma machine_op_lift_no_fpu[Retype_IF_assms]:
  "no_fpu (machine_op_lift mop)"
  by wp

lemma clearMemory_no_hyp[Retype_IF_assms]:
  "no_hyp (clearMemory ptr bits)"
  by wp

lemma freeMemory_no_hyp[Retype_IF_assms]:
  "no_hyp (freeMemory ptr bits)"
  by wp

lemma clearMemory_no_fpu[Retype_IF_assms]:
  "no_fpu (clearMemory ptr bits)"
  by wp

lemma freeMemory_no_fpu[Retype_IF_assms]:
