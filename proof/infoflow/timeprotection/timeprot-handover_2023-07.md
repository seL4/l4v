...
- Time protection of new **ASpec**: Gives assurances about seL4 as specified.
...
- Time protection of new CSpec: Gives assurances about seL4's C implementation.
  - *Labour estimate*: 1-2 person-years (FM postdoc-level)
...
- Time-protected one-way notifications & shared memory: Enables ideal use case.
...
- Time protection IRQ partitioning verification: Support more IRQs than timer.
