...
lemma arch_recycleCap_improve_cases:
   "\<lbrakk> \<not> isFrameCap cap; \<not> isPageTableCap cap; \<not> isASIDControlCap cap \<rbrakk>
...
lemmas arch_assms =
  RISCV64.sameRegionAs_eq_child
  RISCV64.sameRegionAs_eq_parent
  RISCV64.sameRegion_ep
  RISCV64.sameRegion_ntfn
