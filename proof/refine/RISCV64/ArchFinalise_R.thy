...
crunch Arch_finaliseCap, prepareThreadDelete, archThreadSet
  ...
  and bounded'[Arch_assms, wp]: "pspace_bounded'"
  and canonical'[Arch_assms, wp]: "pspace_canonical'"
...
crunch prepareThreadDelete, Arch_finaliseCap
  ...
  and irq_node'[Arch_assms, wp]: "\<lambda>s. P (irq_node' s)"
   ...
   apply (wpsimp wp: prepares_delete_helper'' [OF cancelAllIPC_unlive]
     ...
     apply (wpsimp wp: schedContextMaybeUnbindNtfn_obj_at'_ntfnSc
        ...
        apply (wpsimp wp: schedContextSetInactive_removeable'
                          ...
                          suspend_tcbSchedPrev_tcbSchedNext_None
    ...
    apply (rule hoare_strengthen_post[OF RISCV64.arch_finaliseCap_removeable[where slot=slot]],
