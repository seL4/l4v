...
lemma setIRQState_invs[wp]:
  ...
  apply (clarsimp simp: invs'_def valid_irq_node'_def
                        ...
                        bitmapQ_defs valid_bitmaps_def irqs_masked'_def
                  split: option.splits)
  apply fastforce
  done
...
lemma getIRQSlot_real_cte[wp]:
  ...
  apply wp
  apply (clarsimp simp: invs'_def valid_irq_node'_def shiftl_t2n cteSizeBits_cte_level_bits)
  done
...
method invs'_independent_method
  = clarsimp simp: irq_state_independent_H_def invs'_def
                   ...
                   valid_global_refs'_def valid_irq_node'_def
