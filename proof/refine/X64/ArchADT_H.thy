...
definition absPageTable ::
  "(obj_ref \<rightharpoonup> Structures_H.kernel_object) \<Rightarrow> obj_ref \<Rightarrow> 9 word \<Rightarrow> X64_A.pte"
  where
...
definition absPageDirectory ::
  "(obj_ref \<rightharpoonup> Structures_H.kernel_object) \<Rightarrow> obj_ref \<Rightarrow> 9 word \<Rightarrow>  X64_A.pde"
  where
  "absPageDirectory h a \<equiv> \<lambda>offs.
   case (h (a + (ucast offs << 3))) of
...
definition absPDPT ::
  "(obj_ref \<rightharpoonup> Structures_H.kernel_object) \<Rightarrow> obj_ref \<Rightarrow> 9 word \<Rightarrow>  X64_A.pdpte"
  where
  "absPDPT h a \<equiv> \<lambda>offs.
   case (h (a + (ucast offs << 3))) of
...
definition absPML4 ::
  "(obj_ref \<rightharpoonup> Structures_H.kernel_object) \<Rightarrow> obj_ref \<Rightarrow> 9 word \<Rightarrow>  X64_A.pml4e"
  where
  "absPML4 h a \<equiv> \<lambda>offs.
   case (h (a + (ucast offs << 3))) of
