...
definition APIType_map2 :: "kernel_object + X64_H.object_type \<Rightarrow> Structures_A.apiobject_type"
  where
  ...
  "APIType_map2 ty \<equiv> case ty of
    ...
    | Inr VCPUObject \<Rightarrow> ArchObject X64_A.VCPUObj
...
definition APIType_capBits :: "X64_H.object_type \<Rightarrow> nat \<Rightarrow> nat" where
    ...
    next
      case CapTableObject with Some cover ct show ?thesis
        ...
        apply (simp_all add: X64_H.toAPIType_def
                      ...
                      split: X64_H.object_type.splits)
        apply wp
         apply (clarsimp simp: X64_H.toAPIType_def APIType_capBits_gen_def objBits_simps
...
lemmas makeObjectKO_simps =
  makeObjectKO_def[split_simps X64_H.object_type.split apiobject_type.split sum.split
                               kernel_object.split ]
