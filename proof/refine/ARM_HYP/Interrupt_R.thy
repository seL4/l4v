...
| "arch_irq_control_inv_relation (ARM_HYP_A.IssueSGISignal irq targets ptr ptr') x =
     (x = ARM_HYP_H.IssueSGISignal (ucast irq) (ucast targets) (cte_map ptr) (cte_map ptr'))"
