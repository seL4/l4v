...
lemma capMasterCap_valid_arch_badges_isCapRevocable[CSpace_R_assms]:
  ...
  apply (clarsimp simp: ARM_HYP_H.isCapRevocable_def)
...
lemma ex_nonz_tcb_cte_caps':
  ...
  apply (subgoal_tac "s \<turnstile>' cteCap cte")
   ...
   apply (clarsimp simp: valid_cap'_def obj_at'_def dom_def ARM_HYP.typ_at_to_obj_at_arches
...
lemma maskedAsFull_revokable_safe_parent[CSpace_R_2_assms]:
  ...
  apply (clarsimp simp: Retype_H.isCapRevocable_def ARM_HYP_H.isCapRevocable_def maskedAsFull_def
