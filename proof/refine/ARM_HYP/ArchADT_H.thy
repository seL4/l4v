...
definition absPageTable ::
  "(obj_ref \<rightharpoonup> Structures_H.kernel_object) \<Rightarrow> obj_ref \<Rightarrow> 9 word \<Rightarrow> ARM_HYP_A.pte"
  where
...
definition absPageDirectory ::
  "(obj_ref \<rightharpoonup> Structures_H.kernel_object) \<Rightarrow> obj_ref \<Rightarrow> 11 word \<Rightarrow>  ARM_HYP_A.pde"
  where
