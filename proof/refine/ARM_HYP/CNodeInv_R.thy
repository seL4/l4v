...
lemma saveVirtTimer_irq_states'[wp]:
  ...
  by (wpsimp simp: get_cntv_off_64_def get_cntv_cval_64_def
...
lemma restoreVirtTimer_irq_states'[wp]:
  ...
  by (wpsimp wp: maskInterrupt_irq_states' getIRQState_wp hoare_vcg_imp_lift' doMachineOp_irq_states'
             simp: if_apply_def2 set_cntv_off_64_def set_cntv_cval_64_def liftM_bind)
