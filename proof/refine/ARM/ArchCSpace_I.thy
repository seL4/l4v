...
interpretation CSpace_I?: CSpace_I ARM.arch_capMasterCap
proof goal_cases
  interpret Arch  .
...
interpretation CSpace_I_2?: CSpace_I_2 ARM.arch_capMasterCap
proof goal_cases
  interpret Arch  .
...
definition vsCapRef :: "capability \<Rightarrow> vs_ref list option" where
