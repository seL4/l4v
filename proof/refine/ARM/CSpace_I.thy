...
lemma capMasterCap_simps[simp]:
  ...
  "capMasterCap (capability.ArchObjectCap (arch_capability.SGISignalCap s_irq targets)) =
            capability.ArchObjectCap (arch_capability.SGISignalCap s_irq targets)"
...
lemma capRange_empty_simps[simp]:
  ...
  "capRange (ArchObjectCap (SGISignalCap irq targets)) = {}"
