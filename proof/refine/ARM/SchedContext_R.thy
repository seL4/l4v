...
lemma updateSchedContext_valid_objs'[wp]:
  ...
  by (fastforce simp: valid_obj'_def valid_sched_context'_def valid_sched_context_size'_def
                      obj_at'_def projectKOs scBits_simps objBits_simps opt_map_red opt_pred_def)
...
lemma schedContextCancelYieldTo_valid_pde_mappings'[wp]:
  ...
  apply (clarsimp simp: schedContextCancelYieldTo_def setSchedContext_def updateSchedContext_def)
...
lemma schedContextCancelYieldTo_corres:
  ...
  apply (clarsimp simp: sched_context_cancel_yield_to_def schedContextCancelYieldTo_def
                        updateSchedContext_def comp_def maybeM_def)
  apply (rule corres_guard_imp)
