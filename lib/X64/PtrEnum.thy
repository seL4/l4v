...
begin
  ...
  definition "enum_ptr \<equiv> map Ptr (enum_class.enum :: 64 word list)"
  definition "enum_all_ptr P \<equiv> enum_class.enum_all (\<lambda>v :: 64 word. P (Ptr v))"
  definition "enum_ex_ptr P \<equiv> enum_class.enum_ex (\<lambda>v :: 64 word. P (Ptr v))"
